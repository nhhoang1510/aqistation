...
\begin{table}[H]
\centering
\caption{Bảng sơ đồ chân giao tiếp ngoại vi của ESP32}
\label{tab:gpio}
\begin{tabular}{|l|l|l|}
\hline
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{images/dashboard_top.png}
    \caption{Giao diện trang Tổng quan (Dashboard) với chỉ số AQI và thẻ thông số}
...
\begin{figure}[H]
    ...
    \caption{Hệ thống biểu đồ thời gian thực cho 6 thông số môi trường}
    \label{fig:dashboard_charts}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{images/history_top.png}
    \caption{Trang Lịch sử dữ liệu với khối thống kê tổng hợp và biểu đồ AQI}
    \label{fig:history_top}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{images/history_table.png}
    \caption{Bảng chi tiết các bản ghi dữ liệu lịch sử theo thời gian thực}
...
\begin{figure}[H]
    ...
    \caption{Giao diện thiết lập cấu hình cảnh báo chất lượng không khí}

...
\begin{figure}[H]
\centering
\textbf{[Sơ đồ TikZ đã được lược bỏ để giảm thời gian biên dịch (tránh Overleaf Timeout). Bạn có thể thêm lại dưới dạng ảnh tĩnh (.png) để báo cáo chạy nhanh hơn.]}

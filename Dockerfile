...
# Đảm bảo bạn đã upload file này lên Github theo đúng đường dẫn backend/telegraf/telegraf.conf
COPY backend/telegraf/telegraf.conf /etc/telegraf/telegraf.conf
